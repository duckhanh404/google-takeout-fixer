...
#     media_date =  data.get("CreateDate") or data.get("ModifyDate")
#     print(media_date)
...
def get_media_create_timestamp(path: Path | str) -> int | None:
    ...
    for key in ["DateTimeOriginal", "CreateDate", "MediaCreateDate", "ModifyDate", "FileModifyDate","DateCreated"]:
        if key in data:
            dt_str = data[key]
            # print(f'{key} found: {dt_str}')
            break
    else:
        return None
...
if __name__ == "__main__":
    test_path = r"/Users/hannada/Desktop/IMG_1842-đã-chỉnh-sửa.PNG"
